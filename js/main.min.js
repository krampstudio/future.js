...
var fwc = require('future.js').fwc;
var prism = require('prismjs');

fwc('code').on('error', function (e) {
    ...
    var hlContent = prism.highlight(elt.textContent.trim(), prism.languages[lang]);
    elt.innerHTML = '<pre class="language-' + lang + '"><code class="language-' + lang + '">' + hlContent + '</code></pre>';
}).attrs('lang').register();

},{"future.js":9,"prismjs":4}],2:[function(require,module,exports){
'use strict';

var router = require('future.js').router;

require('./components/code/code.js');

},{"./components/code/code.js":1,"future.js":9}],3:[function(require,module,exports){
...
},{"./elements.json":6,"./eventify.js":7}],9:[function(require,module,exports){
/**
 * Future.js - 2015
 * @author Bertrand Chevrier <chevrier.bertrand@gmail.com>
 * @license MIT
...
},{"./fwc.js":8,"./router.js":10,"babel/polyfill":101}],10:[function(require,module,exports){
/**
 * Future.js - 2015
 * @author Bertrand Chevrier <chevrier.bertrand@gmail.com>
 * @license MIT
...
},{"url-pattern":5}],11:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/shim":98,"regenerator/runtime":99}],12:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
var $ = require('./$');
...
},{"./$":32}],13:[function(require,module,exports){
// 0 -> Array#forEach
// 1 -> Array#map
// 2 -> Array#filter
// 3 -> Array#some
...
},{"./$":32,"./$.ctx":21}],14:[function(require,module,exports){
var $ = require('./$');
...
},{"./$":32}],15:[function(require,module,exports){
var $        = require('./$')
...
},{"./$":32,"./$.enum-keys":24}],16:[function(require,module,exports){
var $        = require('./$')
...
module.exports = cof;
},{"./$":32,"./$.wks":49}],17:[function(require,module,exports){
'use strict';
var $        = require('./$')
  , ctx      = require('./$.ctx')
...
},{"./$":32,"./$.assert":14,"./$.ctx":21,"./$.for-of":25,"./$.iter":31,"./$.iter-define":29,"./$.mix":34,"./$.uid":47}],18:[function(require,module,exports){
...
},{"./$":32,"./$.array-methods":13,"./$.assert":14,"./$.for-of":25,"./$.mix":34,"./$.uid":47}],20:[function(require,module,exports){
'use strict';
var $     = require('./$')
  , $def  = require('./$.def')
...
},{"./$":32,"./$.assert":14,"./$.cof":16,"./$.def":22,"./$.for-of":25,"./$.iter":31,"./$.iter-detect":30,"./$.mix":34,"./$.redef":37,"./$.species":41}],21:[function(require,module,exports){
...
module.exports = $def;
},{"./$":32,"./$.redef":37}],23:[function(require,module,exports){
var $        = require('./$')
  , document = $.g.document
  , isObject = $.isObject
...
},{"./$.ctx":21,"./$.iter":31,"./$.iter-call":28}],26:[function(require,module,exports){
...
},{"./$":32,"./$.cof":16,"./$.def":22,"./$.iter":31,"./$.redef":37,"./$.wks":49}],30:[function(require,module,exports){
...
},{"./$.wks":49}],31:[function(require,module,exports){
'use strict';
var $                 = require('./$')
  , cof               = require('./$.cof')
...
},{"./$":32,"./$.assert":14,"./$.cof":16,"./$.shared":40,"./$.wks":49}],32:[function(require,module,exports){
'use strict';
...
},{"./$.fw":26}],33:[function(require,module,exports){
var $ = require('./$');
...
},{"./$":32,"./$.assert":14}],36:[function(require,module,exports){
'use strict';
var $      = require('./$')
...
},{"./$":32,"./$.assert":14,"./$.invoke":27}],37:[function(require,module,exports){
var $   = require('./$')
...
},{"./$":32,"./$.uid":47}],38:[function(require,module,exports){
'use strict';
...
},{"./$":32,"./$.assert":14,"./$.ctx":21}],40:[function(require,module,exports){
var $      = require('./$')
...
},{"./$":32}],41:[function(require,module,exports){
var $       = require('./$')
...
},{"./$":32,"./$.wks":49}],42:[function(require,module,exports){
// true  -> String#at
...
},{"./$":32}],43:[function(require,module,exports){
...
},{"./$":32,"./$.string-repeat":44}],44:[function(require,module,exports){
'use strict';
var $ = require('./$');
...
},{"./$":32}],45:[function(require,module,exports){
'use strict';
var $      = require('./$')
  , ctx    = require('./$.ctx')
  , cof    = require('./$.cof')
...
},{"./$":32,"./$.cof":16,"./$.ctx":21,"./$.dom-create":23,"./$.invoke":27}],46:[function(require,module,exports){
module.exports = function(exec){
  try {
    exec();
    return false;
...
module.exports = uid;
},{"./$":32}],48:[function(require,module,exports){
...
},{"./$":32,"./$.wks":49}],49:[function(require,module,exports){
...
},{"./$":32,"./$.shared":40,"./$.uid":47}],50:[function(require,module,exports){
var $                = require('./$')
  , cel              = require('./$.dom-create')
  , cof              = require('./$.cof')
  , $def             = require('./$.def')
...
},{"./$":32,"./$.array-includes":12,"./$.array-methods":13,"./$.assert":14,"./$.cof":16,"./$.def":22,"./$.dom-create":23,"./$.invoke":27,"./$.replacer":38,"./$.throws":46,"./$.uid":47}],51:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":32,"./$.def":22,"./$.unscope":48}],52:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":32,"./$.def":22,"./$.unscope":48}],53:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":13,"./$.def":22,"./$.unscope":48}],54:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":13,"./$.def":22,"./$.unscope":48}],55:[function(require,module,exports){
var $     = require('./$')
  , ctx   = require('./$.ctx')
  , $def  = require('./$.def')
  , $iter = require('./$.iter')
...
},{"./$":32,"./$.ctx":21,"./$.def":22,"./$.iter":31,"./$.iter-call":28,"./$.iter-detect":30}],56:[function(require,module,exports){
var $          = require('./$')
...
setUnscope('values');
setUnscope('entries');
},{"./$":32,"./$.iter":31,"./$.iter-define":29,"./$.uid":47,"./$.unscope":48}],57:[function(require,module,exports){
var $def = require('./$.def');
$def($def.S, 'Array', {
...
},{"./$.def":22}],58:[function(require,module,exports){
...
},{"./$":32,"./$.wks":49}],60:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , NAME = 'name'
  , setDesc = $.setDesc
...
},{"./$":32}],61:[function(require,module,exports){
'use strict';
...
},{"./$":32,"./$.redef":37}],64:[function(require,module,exports){
var $     = require('./$')
  , $def  = require('./$.def')
  , abs   = Math.abs
  , floor = Math.floor
...
},{"./$":32,"./$.def":22}],65:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $def = require('./$.def');
$def($def.S, 'Object', {assign: require('./$.assign')});
},{"./$.assign":15,"./$.def":22}],66:[function(require,module,exports){
...
},{"./$.def":22,"./$.set-proto":39}],68:[function(require,module,exports){
var $        = require('./$')
  , $def     = require('./$.def')
  , isObject = $.isObject
  , toObject = $.toObject;
...
},{"./$":32,"./$.def":22}],69:[function(require,module,exports){
'use strict';
...
},{"./$":32,"./$.cof":16,"./$.redef":37,"./$.wks":49}],70:[function(require,module,exports){
'use strict';
var $        = require('./$')
  , ctx      = require('./$.ctx')
  , cof      = require('./$.cof')
...
},{"./$":32,"./$.assert":14,"./$.cof":16,"./$.ctx":21,"./$.def":22,"./$.for-of":25,"./$.iter-detect":30,"./$.mix":34,"./$.set-proto":39,"./$.species":41,"./$.task":45,"./$.uid":47,"./$.wks":49}],71:[function(require,module,exports){
var $         = require('./$')
  , $def      = require('./$.def')
...
},{"./$":32,"./$.assert":14,"./$.def":22,"./$.iter":31,"./$.own-keys":35,"./$.set-proto":39,"./$.uid":47,"./$.wks":49}],72:[function(require,module,exports){
var $       = require('./$')
  , cof     = require('./$.cof')
  , $RegExp = $.g.RegExp
  , Base    = $RegExp
...
},{"./$":32,"./$.cof":16,"./$.redef":37,"./$.replacer":38,"./$.species":41}],73:[function(require,module,exports){
'use strict';
var strong = require('./$.collection-strong');
...
},{"./$.collection":20,"./$.collection-strong":17}],74:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":22,"./$.string-at":42}],75:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def')
...
},{"./$":32,"./$.cof":16,"./$.def":22,"./$.throws":46}],76:[function(require,module,exports){
var $def    = require('./$.def')
...
},{"./$":32,"./$.def":22}],77:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":32,"./$.cof":16,"./$.def":22}],78:[function(require,module,exports){
var set   = require('./$').set
...
},{"./$":32,"./$.iter":31,"./$.iter-define":29,"./$.string-at":42,"./$.uid":47}],79:[function(require,module,exports){
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":32,"./$.def":22}],80:[function(require,module,exports){
var $def = require('./$.def');
...
},{"./$.def":22,"./$.string-repeat":44}],81:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":32,"./$.cof":16,"./$.def":22,"./$.throws":46}],82:[function(require,module,exports){
'use strict';
...
},{"./$":32,"./$.assert":14,"./$.cof":16,"./$.def":22,"./$.enum-keys":24,"./$.keyof":33,"./$.redef":37,"./$.shared":40,"./$.uid":47,"./$.wks":49}],83:[function(require,module,exports){
'use strict';
var $         = require('./$')
...
},{"./$":32,"./$.collection":20,"./$.collection-weak":19,"./$.redef":37}],84:[function(require,module,exports){
'use strict';
...
},{"./$.array-includes":12,"./$.def":22,"./$.unscope":48}],86:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Map');
},{"./$.collection-to-json":18}],87:[function(require,module,exports){
...
},{"./$":32,"./$.def":22,"./$.own-keys":35}],88:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":32,"./$.def":22}],89:[function(require,module,exports){
// https://gist.github.com/kangax/9698100
var $def = require('./$.def');
$def($def.S, 'RegExp', {
  escape: require('./$.replacer')(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)
});
},{"./$.def":22,"./$.replacer":38}],90:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Set');
},{"./$.collection-to-json":18}],91:[function(require,module,exports){
...
},{"./$.def":22,"./$.string-at":42}],92:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":22,"./$.string-pad":43}],93:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
  , $pad = require('./$.string-pad');
$def($def.P, 'String', {
...
},{"./$.def":22,"./$.string-pad":43}],94:[function(require,module,exports){
...
},{"./$":32,"./$.ctx":21,"./$.def":22}],95:[function(require,module,exports){
...
},{"./$":32,"./$.iter":31,"./$.wks":49,"./es6.array.iterator":56}],96:[function(require,module,exports){
var $def  = require('./$.def')
  , $task = require('./$.task');
$def($def.G + $def.B, {
...
},{"./$.def":22,"./$.task":45}],97:[function(require,module,exports){
...
},{"./$":32,"./$.def":22,"./$.invoke":27,"./$.partial":36}],98:[function(require,module,exports){
require('./modules/es5');
...
},{"_process":3}],100:[function(require,module,exports){
module.exports = require("./lib/babel/polyfill");

},{"./lib/babel/polyfill":11}],101:[function(require,module,exports){
module.exports = require("babel-core/polyfill");

},{"babel-core/polyfill":100}]},{},[2])
