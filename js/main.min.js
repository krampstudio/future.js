...
var _futureJs = require('future.js');

var _prismjs = require('prismjs');

var _prismjs2 = _interopRequireDefault(_prismjs);

(0, _futureJs.fwc)('code').on('error', function (e) {
    return console.error(e);
}).on('create', function (elt) {
    var lang = elt.lang;
    if (!lang || !_prismjs2['default'].languages.hasOwnProperty(lang)) {
        return this.trigger('error', new Error('unsupported language : ' + lang));
    }
    var hlContent = _prismjs2['default'].highlight(elt.textContent.trim(), _prismjs2['default'].languages[lang]);
    elt.innerHTML = '<pre class="language-' + lang + '"><code class="language-' + lang + '">' + hlContent + '</code></pre>';
}).attrs('lang').register();

},{"future.js":10,"prismjs":5}],2:[function(require,module,exports){
'use strict';

var _futureJs = require('future.js');

// load is the component name, it uses the default namespace 'f-'
(0, _futureJs.fwc)('load')
...
},{"future.js":10}],3:[function(require,module,exports){
'use strict';
...
},{"./components/code/code.js":1,"./components/load/load.js":2}],4:[function(require,module,exports){
                ...
                if (typeof data.content === 'function') {
                    ...
                    try {
                        for (var _iterator2 = comp.attrs()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            ...
                            contentContext[attr] = elt[attr]; //so the getter is called
                        }
                    } catch (err) {
                    ...
                    //use initial content instead
                    //contentContext.textContent = elt.textContent;
                    //contentContext.innerHTML   = elt.innerHTML;

                    self.trigger('rendering', elt);

                    var rendered = data.content.call(elt, contentContext);
...
},{"./elements.json":7,"./eventify.js":8}],10:[function(require,module,exports){
/**
 * Future.js - 2015
 * @author Bertrand Chevrier <chevrier.bertrand@gmail.com>
 * @license MIT
...
},{"./fwc.js":9,"./router.js":11,"babel/polyfill":102}],11:[function(require,module,exports){
/**
 * Future.js - 2015
 * @author Bertrand Chevrier <chevrier.bertrand@gmail.com>
 * @license MIT
...
},{"url-pattern":6}],12:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/shim":99,"regenerator/runtime":100}],13:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
var $ = require('./$');
...
module.exports = cof;
},{"./$":33,"./$.wks":50}],18:[function(require,module,exports){
'use strict';
var $        = require('./$')
  , ctx      = require('./$.ctx')
...
},{"./$":33,"./$.assert":15,"./$.ctx":22,"./$.for-of":26,"./$.iter":32,"./$.iter-define":30,"./$.mix":35,"./$.uid":48}],19:[function(require,module,exports){
...
},{"./$":33,"./$.array-methods":14,"./$.assert":15,"./$.for-of":26,"./$.mix":35,"./$.uid":48}],21:[function(require,module,exports){
'use strict';
var $     = require('./$')
  , $def  = require('./$.def')
...
},{"./$":33,"./$.assert":15,"./$.cof":17,"./$.def":23,"./$.for-of":26,"./$.iter":32,"./$.iter-detect":31,"./$.mix":35,"./$.redef":38,"./$.species":42}],22:[function(require,module,exports){
...
module.exports = $def;
},{"./$":33,"./$.redef":38}],24:[function(require,module,exports){
var $        = require('./$')
  , document = $.g.document
  , isObject = $.isObject
...
},{"./$":33,"./$.cof":17,"./$.def":23,"./$.iter":32,"./$.redef":38,"./$.wks":50}],31:[function(require,module,exports){
...
},{"./$.wks":50}],32:[function(require,module,exports){
'use strict';
var $                 = require('./$')
  , cof               = require('./$.cof')
...
},{"./$":33,"./$.assert":15,"./$.cof":17,"./$.shared":41,"./$.wks":50}],33:[function(require,module,exports){
'use strict';
...
},{"./$":33,"./$.assert":15}],37:[function(require,module,exports){
'use strict';
var $      = require('./$')
...
},{"./$":33,"./$.assert":15,"./$.invoke":28}],38:[function(require,module,exports){
var $   = require('./$')
...
},{"./$":33,"./$.uid":48}],39:[function(require,module,exports){
'use strict';
...
},{"./$":33,"./$.assert":15,"./$.ctx":22}],41:[function(require,module,exports){
var $      = require('./$')
...
},{"./$":33}],42:[function(require,module,exports){
var $       = require('./$')
...
},{"./$":33,"./$.wks":50}],43:[function(require,module,exports){
// true  -> String#at
...
},{"./$":33,"./$.string-repeat":45}],45:[function(require,module,exports){
'use strict';
var $ = require('./$');
...
},{"./$":33}],46:[function(require,module,exports){
'use strict';
var $      = require('./$')
  , ctx    = require('./$.ctx')
  , cof    = require('./$.cof')
...
},{"./$":33,"./$.cof":17,"./$.ctx":22,"./$.dom-create":24,"./$.invoke":28}],47:[function(require,module,exports){
module.exports = function(exec){
  try {
    exec();
    return false;
...
module.exports = uid;
},{"./$":33}],49:[function(require,module,exports){
...
},{"./$":33,"./$.wks":50}],50:[function(require,module,exports){
...
},{"./$":33,"./$.shared":41,"./$.uid":48}],51:[function(require,module,exports){
var $                = require('./$')
  , cel              = require('./$.dom-create')
  , cof              = require('./$.cof')
  , $def             = require('./$.def')
...
},{"./$":33,"./$.array-includes":13,"./$.array-methods":14,"./$.assert":15,"./$.cof":17,"./$.def":23,"./$.dom-create":24,"./$.invoke":28,"./$.replacer":39,"./$.throws":47,"./$.uid":48}],52:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":33,"./$.def":23,"./$.unscope":49}],53:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":33,"./$.def":23,"./$.unscope":49}],54:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":14,"./$.def":23,"./$.unscope":49}],55:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":14,"./$.def":23,"./$.unscope":49}],56:[function(require,module,exports){
var $     = require('./$')
  , ctx   = require('./$.ctx')
  , $def  = require('./$.def')
  , $iter = require('./$.iter')
...
},{"./$":33,"./$.ctx":22,"./$.def":23,"./$.iter":32,"./$.iter-call":29,"./$.iter-detect":31}],57:[function(require,module,exports){
var $          = require('./$')
...
setUnscope('values');
setUnscope('entries');
},{"./$":33,"./$.iter":32,"./$.iter-define":30,"./$.uid":48,"./$.unscope":49}],58:[function(require,module,exports){
var $def = require('./$.def');
$def($def.S, 'Array', {
...
},{"./$.def":23}],59:[function(require,module,exports){
require('./$.species')(Array);
},{"./$.species":42}],60:[function(require,module,exports){
var $             = require('./$')
...
},{"./$":33,"./$.wks":50}],61:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , NAME = 'name'
  , setDesc = $.setDesc
...
},{"./$":33}],62:[function(require,module,exports){
'use strict';
...
},{"./$.collection":21,"./$.collection-strong":18}],63:[function(require,module,exports){
var Infinity = 1 / 0
  , $def  = require('./$.def')
  , E     = Math.E
  , pow   = Math.pow
...
},{"./$.def":23}],64:[function(require,module,exports){
'use strict';
var $          = require('./$')
  , isObject   = $.isObject
  , isFunction = $.isFunction
...
},{"./$":33,"./$.redef":38}],65:[function(require,module,exports){
var $     = require('./$')
  , $def  = require('./$.def')
  , abs   = Math.abs
  , floor = Math.floor
...
},{"./$":33,"./$.def":23}],66:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $def = require('./$.def');
$def($def.S, 'Object', {assign: require('./$.assign')});
},{"./$.assign":16,"./$.def":23}],67:[function(require,module,exports){
...
},{"./$.def":23}],68:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $def = require('./$.def');
$def($def.S, 'Object', {setPrototypeOf: require('./$.set-proto').set});
},{"./$.def":23,"./$.set-proto":40}],69:[function(require,module,exports){
var $        = require('./$')
  , $def     = require('./$.def')
  , isObject = $.isObject
  , toObject = $.toObject;
...
},{"./$":33,"./$.def":23}],70:[function(require,module,exports){
'use strict';
...
},{"./$":33,"./$.cof":17,"./$.redef":38,"./$.wks":50}],71:[function(require,module,exports){
'use strict';
var $        = require('./$')
  , ctx      = require('./$.ctx')
  , cof      = require('./$.cof')
...
},{"./$":33,"./$.assert":15,"./$.cof":17,"./$.ctx":22,"./$.def":23,"./$.for-of":26,"./$.iter-detect":31,"./$.mix":35,"./$.set-proto":40,"./$.species":42,"./$.task":46,"./$.uid":48,"./$.wks":50}],72:[function(require,module,exports){
var $         = require('./$')
  , $def      = require('./$.def')
...
},{"./$":33,"./$.assert":15,"./$.def":23,"./$.iter":32,"./$.own-keys":36,"./$.set-proto":40,"./$.uid":48,"./$.wks":50}],73:[function(require,module,exports){
var $       = require('./$')
  , cof     = require('./$.cof')
  , $RegExp = $.g.RegExp
  , Base    = $RegExp
...
},{"./$":33,"./$.cof":17,"./$.redef":38,"./$.replacer":39,"./$.species":42}],74:[function(require,module,exports){
'use strict';
var strong = require('./$.collection-strong');
...
},{"./$.collection":21,"./$.collection-strong":18}],75:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":23,"./$.string-at":43}],76:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def')
...
},{"./$":33,"./$.cof":17,"./$.def":23,"./$.throws":47}],77:[function(require,module,exports){
var $def    = require('./$.def')
...
},{"./$":33,"./$.def":23}],78:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":33,"./$.cof":17,"./$.def":23}],79:[function(require,module,exports){
var set   = require('./$').set
...
},{"./$":33,"./$.iter":32,"./$.iter-define":30,"./$.string-at":43,"./$.uid":48}],80:[function(require,module,exports){
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":33,"./$.def":23}],81:[function(require,module,exports){
var $def = require('./$.def');
...
},{"./$.def":23,"./$.string-repeat":45}],82:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":33,"./$.cof":17,"./$.def":23,"./$.throws":47}],83:[function(require,module,exports){
'use strict';
...
},{"./$":33,"./$.assert":15,"./$.cof":17,"./$.def":23,"./$.enum-keys":25,"./$.keyof":34,"./$.redef":38,"./$.shared":41,"./$.uid":48,"./$.wks":50}],84:[function(require,module,exports){
'use strict';
var $         = require('./$')
...
},{"./$":33,"./$.collection":21,"./$.collection-weak":20,"./$.redef":38}],85:[function(require,module,exports){
'use strict';
...
},{"./$.collection":21,"./$.collection-weak":20}],86:[function(require,module,exports){
...
},{"./$.array-includes":13,"./$.def":23,"./$.unscope":49}],87:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Map');
},{"./$.collection-to-json":19}],88:[function(require,module,exports){
...
},{"./$":33,"./$.def":23,"./$.own-keys":36}],89:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":33,"./$.def":23}],90:[function(require,module,exports){
// https://gist.github.com/kangax/9698100
var $def = require('./$.def');
$def($def.S, 'RegExp', {
  escape: require('./$.replacer')(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)
});
},{"./$.def":23,"./$.replacer":39}],91:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Set');
},{"./$.collection-to-json":19}],92:[function(require,module,exports){
...
},{"./$.def":23,"./$.string-at":43}],93:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":23,"./$.string-pad":44}],94:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
  , $pad = require('./$.string-pad');
$def($def.P, 'String', {
...
},{"./$.def":23,"./$.string-pad":44}],95:[function(require,module,exports){
...
},{"./$":33,"./$.ctx":22,"./$.def":23}],96:[function(require,module,exports){
...
},{"./$":33,"./$.iter":32,"./$.wks":50,"./es6.array.iterator":57}],97:[function(require,module,exports){
var $def  = require('./$.def')
  , $task = require('./$.task');
$def($def.G + $def.B, {
...
},{"./$.def":23,"./$.task":46}],98:[function(require,module,exports){
...
},{"./$":33,"./$.def":23,"./$.invoke":28,"./$.partial":37}],99:[function(require,module,exports){
require('./modules/es5');
...
},{"./modules/$":33,"./modules/es5":51,"./modules/es6.array.copy-within":52,"./modules/es6.array.fill":53,"./modules/es6.array.find":55,"./modules/es6.array.find-index":54,"./modules/es6.array.from":56,"./modules/es6.array.iterator":57,"./modules/es6.array.of":58,"./modules/es6.array.species":59,"./modules/es6.function.has-instance":60,"./modules/es6.function.name":61,"./modules/es6.map":62,"./modules/es6.math":63,"./modules/es6.number.constructor":64,"./modules/es6.number.statics":65,"./modules/es6.object.assign":66,"./modules/es6.object.is":67,"./modules/es6.object.set-prototype-of":68,"./modules/es6.object.statics-accept-primitives":69,"./modules/es6.object.to-string":70,"./modules/es6.promise":71,"./modules/es6.reflect":72,"./modules/es6.regexp":73,"./modules/es6.set":74,"./modules/es6.string.code-point-at":75,"./modules/es6.string.ends-with":76,"./modules/es6.string.from-code-point":77,"./modules/es6.string.includes":78,"./modules/es6.string.iterator":79,"./modules/es6.string.raw":80,"./modules/es6.string.repeat":81,"./modules/es6.string.starts-with":82,"./modules/es6.symbol":83,"./modules/es6.weak-map":84,"./modules/es6.weak-set":85,"./modules/es7.array.includes":86,"./modules/es7.map.to-json":87,"./modules/es7.object.get-own-property-descriptors":88,"./modules/es7.object.to-array":89,"./modules/es7.regexp.escape":90,"./modules/es7.set.to-json":91,"./modules/es7.string.at":92,"./modules/es7.string.lpad":93,"./modules/es7.string.rpad":94,"./modules/js.array.statics":95,"./modules/web.dom.iterable":96,"./modules/web.immediate":97,"./modules/web.timers":98}],100:[function(require,module,exports){
...
},{"./lib/babel/polyfill":12}],102:[function(require,module,exports){
module.exports = require("babel-core/polyfill");

},{"babel-core/polyfill":101}]},{},[3])
