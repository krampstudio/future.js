...
_qunitjs2['default'].test("factory", 4, function (assert) {
    ...
    assert.notDeepEqual(routing, (0, _router2['default'])(), "the router is a factory and creates an new router instance");
});
...
_qunitjs2['default'].test("config", 6, function (assert) {
    ...
    assert.throws(function () {
        return (0, _router2['default'])([{ 'foo': 'bar' }]);
    }, TypeError, "Wrong route");
    assert.throws(function () {
        return (0, _router2['default'])([{ 'url': '/foo' }]);
    }, TypeError, "Missing handlers");
    assert.throws(function () {
        return (0, _router2['default'])([{ 'url': '/foo', 'handlers': true }]);
    }, TypeError, "Wrong handlers");
    assert.throws(function () {
        return (0, _router2['default'])([{ 'url': '/foo', 'handlers': [] }]);
...
},{"../sauce.js":3,"qunitjs":1,"router":"router"}],3:[function(require,module,exports){
